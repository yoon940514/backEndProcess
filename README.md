...
학원에서는 순수 jdbc와 dbcp, 순수 servlet + jsp 위주로 학습하여서 3월 중순에 수료 후 현재 spring framework와 spring boots를 계속 공부하고 있습니다. 현재 다양한 테이블을 더 추가하여 ERD를 직접 작성하여 이것을 토대로 Spring boot 프로젝트도 만들고 있는 중입니다.
