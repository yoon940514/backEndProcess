 ...
 */
@WebServlet("*.Xml")
public class GongsiXml extends HttpServlet {
	...
	protected void action(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{ 
			...
			String apiURL="https://opendart.fss.or.kr/api/fnlttSinglAcnt.xml?crtfc_key=4da9032c12da1e518c695159c47bf9d9c7934752&corp_code=" + corp_code + ""
			...
			try {
				...
				if (conn.getResponseCode() == 200) { 
					...
					request.getRequestDispatcher("api/resultXml.jsp").forward(request, response);
