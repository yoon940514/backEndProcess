...
public class BoardPaging {
	...
	private ArrayList <MvcBoardDto> list10;
	public BoardPaging() {
	}
	
	public BoardPaging(int pstartno) {
	...
	public BoardPaging(int pageTotal, int onePageLimit, int pageAll, int bottomList, int startBtn, int endBtn,
			int currentBtn, ArrayList<MvcBoardDto> list10, int pstartno) {
		super();
	...
	public ArrayList<MvcBoardDto> getList10() {
		return list10;
	}
	public void setList10(ArrayList<MvcBoardDto> list10) {
		this.list10 = list10;
	}
